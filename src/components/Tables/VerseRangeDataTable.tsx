// src/components/Tables/VerseRangeDataTable.tsx
...
interface VerseRangeDataTableProps {
  data: VerseData[];
  startIndex?: number;
}

const VerseRangeDataTable: React.FC<VerseRangeDataTableProps> = ({ data, startIndex = 0 }) => {
  return (
    <Table>
      <TableHeader>
        <TableRow>
...
export default VerseRangeDataTable;